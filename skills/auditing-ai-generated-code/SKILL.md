...
**Core principle:** Every finding must be locatable in the code provided. No invented problems. No unnecessary rewrites. No inflated scores.
...
- Give a score above 7/10 to code with any CRITICAL finding
